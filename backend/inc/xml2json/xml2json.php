	...
	*/	
	public static function transformXmlStringToJson($xmlStringContents) {
		...
		*/
		...
		//CHANGE DOMINIK STOCKER 7. Feb. 2011
		//HANDLING IF ARRAY IS EMPTY (XML IS EMTPY):
		else {
			if (isset($simpleXmlRootElementName) && $simpleXmlRootElementName != "") {
				$jsonOutput = '{"'. $simpleXmlRootElementName .'":{}}';
			}
		}
		return($jsonOutput);					
